...
def test_cookiefile(request, firmware, password, httpserver, caplog):
    ...
    retriever.__del__()  # pylint: disable=bad-option-value,unnecessary-dunder-call
    del retriever
    ...
    httpserver.check_assertions()
    # Execute destructor, pytest messes around with the reference count
    retrieverNew.__del__()  # pylint: disable=bad-option-value,unnecessary-dunder-call
    del retrieverNew
    ...
    httpserver.check_assertions()
    # Execute destructor, pytest messes around with the reference count
    retrieverNew2.__del__()  # pylint: disable=bad-option-value,unnecessary-dunder-call
    del retrieverNew2
